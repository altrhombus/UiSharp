...
///     UISHARP_UPDATE_GOLDEN=1 dotnet test src/UiSharp.Core.Tests
/// then review the diff before committing.
/// </summary>
public class SampleConfigParityTests
{
    private static bool UpdateGolden =>
        Environment.GetEnvironmentVariable("UISHARP_UPDATE_GOLDEN") == "1";
    ...
    public void SampleConfig_MatchesGoldenSnapshot(string fileName)
    {
        ...
        Assert.True(File.Exists(goldenPath),
            $"No golden snapshot at {goldenPath}. Run with UISHARP_UPDATE_GOLDEN=1 to create it.");
        ...
        Assert.Fail(
            ...
            "If this change is intended, regenerate with UISHARP_UPDATE_GOLDEN=1 and review the diff.");
    }
